...
const PasswordChange = () => {
  ...
  return (
    <div className="max-w-screen min-h-[200px] sm:w-[620px] text-sm sm:text-md sm:aspect-[5/2] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-3 grid grid-rows-[1fr_4fr] shadow-[2px_2px_35px_12px_rgba(0,0,0,0.12)] relative">
      <button
